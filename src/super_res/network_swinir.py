#
# Original code from: https://github.com/JingyunLiang/SwinIR
#
# -----------------------------------------------------------------------------------
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
                 ...
                 act_layer=nn.GELU, norm_layer=nn.LayerNorm, kernel_size=3):
        super().__init__()
        self.dim = dim
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 ...
                 use_lepe=False, use_cpb_bias=True,
                 MoE_config=None):
...
class RSTB(nn.Module):
    ...
    def forward(self, x, x_size):
        ...
        return (
            self.patch_embed(
                self.conv(self.patch_unembed(res, x_size))) + x
        ), loss_moe
